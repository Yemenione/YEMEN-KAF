...
export default function ShopPage() {
    ...
    return (
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="relative bg-gradient-to-r from-gray-900 via-gray-800 to-black text-white py-16">
                <div className="max-w-7xl mx-auto px-6">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4">Découvrez Notre Collection</h1>
                    <p className="text-lg text-gray-300 max-w-2xl">
                        Produits yéménites authentiques et de qualité supérieure
                    </p>
                </div>
            </div>
